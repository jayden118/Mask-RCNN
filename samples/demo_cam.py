...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 26 15:54:18 2019
...
ROOT_DIR = os.path.abspath("/home/kubota/Desktop/Mask_RCNN_2.0/")
...
class_names = ['BG', 'person', 'bicycle', 'car', 'motorcycle', 'airplane',
               ...
               'dining table', 'toilet', 'monitor screen', 'laptop', 'mouse', 'remote',
               'keyboard', 'cell phone', 'microwave', 'oven', 'toaster',
               'sink', 'refrigerator', 'book', 'clock', 'vase', 'scissors',
               'teddy bear', 'hair drier', 'toothbrush']

colors = visualize2.random_colors(len(class_names))
...
while True:
    ...
    if PROCESS_IMG:    
        ...
        # Run detection
        masked_image = visualize2.display_instances_10fps(frame, r['rois'], r['masks'], 
